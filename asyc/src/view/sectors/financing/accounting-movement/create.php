...
<body>
    <section>
        ...
        <form class="row" action="">
                <h1 class="display-4">Registrar Movimentação</h1>

                <div class="col-md-6">
                    <label class="form-label" for="cost">Custo total</label> 
                    <input class="form-control" type="text" id="cost">
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="cost">Valor pago</label> 
                    <input class="form-control" type="text" id="ammountPaid">
                </div>
                ...
                <div class="col-12"> <!-- melhor com opções -->
                    <label class="form-label" class="form-label" for="formOfPayment">Forma de pagamento</label>
                ...
                <div class="col-md-4">
                    <label class="form-label" for="qtdeInstallmentPaid">Quantidade de parcelas pagas</label>
                    <input class="form-control" type="number" id="qtdeInstallmentPaid">
                </div>
            ...
            <div class="col-md-6">
                <label class="form-label" for="lastPaymentDate">Ultimo pagamento realizado</label>
                <input class="form-control" type="date" id="lastPaymentDate">
            </div>
        </form>

            <div class="d-grid mt-3">
                <input class="btn btn-danger" type="button" type="submit" value="Registrar nova movimentação" >
            </div>
