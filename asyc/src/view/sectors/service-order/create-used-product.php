    ...
    <section>
        ...
        <div class="card  shadow-lg me-auto ms-auto col-md-7 h-75 mt-5 mb-5">
            <div class="card-body p-5 ">
                    ...
                    <h1 class="display-4">Usar Produto</h1>
                    <form class="row" action="" >
                        ...
                        <div class="col-12">
                            <label class="form-label" for="usedProductType">Tipo de produto usado</label>
                            <input  class="form-control" type="text" id="usedProductType">
                        </div>
                    </form>

                <div class="d-grid mt-3">
                    <input class="btn btn-danger" type="button" type="submit" value="Registrar uso de produto" >
                </div>
